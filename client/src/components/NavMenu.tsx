  ...
  return (
    <NavigationMenu>
      <NavigationMenuList className="flex space-x-1">
        {/* Features Menu */}
        <NavigationMenuItem>
          <NavigationMenuTrigger className="text-sm font-medium text-primary-700 hover:text-primary-800 hover:bg-primary-50 data-[state=open]:bg-primary-50 data-[state=open]:text-primary-800">
            Features
          </NavigationMenuTrigger>
          <NavigationMenuContent>
        ...
        <NavigationMenuItem>
          <NavigationMenuLink asChild>
            <Link
              href="/pricing"
              className="px-4 py-2 text-sm font-medium text-primary-700 hover:text-primary-800 hover:bg-primary-50 rounded-md transition-all duration-200"
            >
              Pricing
            </Link>
          </NavigationMenuLink>
